// TODO: https://raw.githubusercontent.com/dacsunlimited/dac_play/master/libraries/game/v8_game.cpp

// Migrate relate game engine codes to here.
...
namespace bts { namespace game {
   ...
   void v8_game_engine::evaluate( const game_play_operation& op )
   {
       auto isolate = my->GetIsolate();
       v8::Locker locker( isolate );
       Isolate::Scope isolate_scope(my->GetIsolate());
